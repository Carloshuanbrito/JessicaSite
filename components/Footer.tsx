      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-16 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-medium text-porcelain tracking-wide">(85) 9.9787-8827</span>
                </div>
          ...
          <div className="space-y-6">
            ...
            <a
              href="https://www.instagram.com/jessica.santos.adv/"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="font-serif italic text-xl text-porcelain font-medium">@jessica.santos.adv</span>
              </div>
            </a>
