  ...
  return (
    <nav 
      className={`fixed w-full z-50 transition-all duration-300 ${
        isScrolled ? 'bg-porcelain/95 backdrop-blur-md shadow-md py-4' : 'bg-porcelain/50 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none py-4 md:py-6'
      }`}
    >
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`fixed inset-0 bg-porcelain/98 backdrop-blur-xl z-40 flex flex-col items-center justify-center transition-all duration-300 lg:hidden ${
